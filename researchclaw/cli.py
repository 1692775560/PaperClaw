...
def _prompt_opencode_install() -> bool:
    ...
    print()
    print("  With OpenCode enabled, PaperClaw can generate multi-file")
...
def cmd_setup(args: argparse.Namespace) -> int:
    ...
    print()
    print("运行 'paperclaw doctor' 或 'researchclaw doctor' 进行完整环境健康检查。")
    return 0
